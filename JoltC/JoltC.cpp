...
#define ENUM_CONVERSION(c_type, cpp_type) \
    static c_type to_jpc(cpp_type in) {   \
        return static_cast<c_type>(in);   \
    }                                     \
    static cpp_type to_jph(c_type in) {   \
        return static_cast<cpp_type>(in); \
    }
...
static auto to_jpc(JPH::BroadPhaseLayer in) {
    return in.GetValue();
}

static auto to_jph(JPC_BroadPhaseLayer in) {
    return JPH::BroadPhaseLayer(in);
}
...
JPC_API JPC_JobSystemThreadPool* JPC_JobSystemThreadPool_new2(unsigned int inMaxJobs, unsigned int inMaxBarriers) {
    return to_jpc(new JPH::JobSystemThreadPool(inMaxJobs, inMaxBarriers));
}

JPC_API JPC_JobSystemThreadPool* JPC_JobSystemThreadPool_new3(unsigned int inMaxJobs, unsigned int inMaxBarriers, int inNumThreads) {
...
class JPC_BroadPhaseLayerInterfaceBridge final : public JPH::BroadPhaseLayerInterface {
   public:
    ...
    virtual unsigned int GetNumBroadPhaseLayers() const override { return fns.GetNumBroadPhaseLayers(self); }
    ...
    virtual const char* GetBroadPhaseLayerName([[maybe_unused]] JPH::BroadPhaseLayer inLayer) const override { return "FIXME"; }
#endif
...
JPC_API JPC_BroadPhaseLayerInterface* JPC_BroadPhaseLayerInterface_new(const void* self, JPC_BroadPhaseLayerInterfaceFns fns) {
...
JPC_API JPC_ObjectVsBroadPhaseLayerFilter* JPC_ObjectVsBroadPhaseLayerFilter_new(const void* self,
                                                                                 JPC_ObjectVsBroadPhaseLayerFilterFns fns) {
...
class JPC_BroadPhaseLayerFilterBridge final : public JPH::BroadPhaseLayerFilter {
   public:
    ...
    virtual bool ShouldCollide(JPH::BroadPhaseLayer inLayer) const override { return fns.ShouldCollide(self, to_jpc(inLayer)); }
...
JPC_API JPC_BroadPhaseLayerFilter* JPC_BroadPhaseLayerFilter_new(const void* self, JPC_BroadPhaseLayerFilterFns fns) {
...
class JPC_ObjectLayerFilterBridge final : public JPH::ObjectLayerFilter {
   public:
    ...
    virtual bool ShouldCollide(JPH::ObjectLayer inLayer) const override { return fns.ShouldCollide(self, inLayer); }
...
JPC_API JPC_ObjectLayerFilter* JPC_ObjectLayerFilter_new(const void* self, JPC_ObjectLayerFilterFns fns) {
...
class JPC_BodyFilterBridge final : public JPH::BodyFilter {
   public:
    ...
    virtual bool ShouldCollide(const JPH::BodyID& inBodyID) const override { return fns.ShouldCollide(self, to_jpc(inBodyID)); }

    virtual bool ShouldCollideLocked(const JPH::Body& inBody) const override { return fns.ShouldCollideLocked(self, to_jpc(&inBody)); }
...
JPC_API JPC_BodyFilter* JPC_BodyFilter_new(const void* self, JPC_BodyFilterFns fns) {
...
JPC_API JPC_ObjectLayerPairFilter* JPC_ObjectLayerPairFilter_new(const void* self, JPC_ObjectLayerPairFilterFns fns) {
...
JPC_API bool JPC_StaticCompoundShapeSettings_Create(const JPC_StaticCompoundShapeSettings* self,
                                                    JPC_Shape** outShape,
                                                    JPC_String** outError) {
...
JPC_API bool JPC_MutableCompoundShapeSettings_Create(const JPC_MutableCompoundShapeSettings* self,
                                                     JPC_Shape** outShape,
                                                     JPC_String** outError) {
...
JPC_API bool JPC_Body_ApplyBuoyancyImpulse(JPC_Body* self,
                                           JPC_RVec3 inSurfacePosition,
                                           JPC_Vec3 inSurfaceNormal,
                                           float inBuoyancy,
                                           float inLinearDrag,
                                           float inAngularDrag,
                                           JPC_Vec3 inFluidVelocity,
                                           JPC_Vec3 inGravity,
                                           float inDeltaTime) {
    return to_jph(self)->ApplyBuoyancyImpulse(to_jph(inSurfacePosition), to_jph(inSurfaceNormal), inBuoyancy, inLinearDrag, inAngularDrag,
                                              to_jph(inFluidVelocity), to_jph(inGravity), inDeltaTime);
}
...
JPC_API JPC_Body* JPC_BodyInterface_CreateBodyWithID(JPC_BodyInterface* self,
                                                     JPC_BodyID inBodyID,
                                                     const JPC_BodyCreationSettings* inSettings) {
    return to_jpc(to_jph(self)->CreateBodyWithID(to_jph(inBodyID), to_jph(inSettings)));
}

// JPC_API JPC_Body* JPC_BodyInterface_CreateSoftBodyWithID(JPC_BodyInterface *self, JPC_BodyID inBodyID, const SoftBodyCreationSettings*
// inSettings);
...
JPC_API JPC_BodyID JPC_BodyInterface_CreateAndAddBody(JPC_BodyInterface* self,
                                                      const JPC_BodyCreationSettings* inSettings,
                                                      JPC_Activation inActivationMode) {
    return to_jpc(to_jph(self)->CreateAndAddBody(to_jph(inSettings), to_jph(inActivationMode)));
}

// JPC_API JPC_BodyID JPC_BodyInterface_CreateAndAddSoftBody(JPC_BodyInterface *self, const SoftBodyCreationSettings &inSettings,
// JPC_Activation inActivationMode);
...
JPC_API void JPC_BodyInterface_AddBodiesFinalize(JPC_BodyInterface* self,
                                                 JPC_BodyID* ioBodies,
                                                 int inNumber,
                                                 void* inAddState,
                                                 JPC_Activation inActivationMode) {
...
// JPC_API void JPC_BodyInterface_ActivateBodiesInAABox(JPC_BodyInterface *self, const AABox &inBox, const BroadPhaseLayerFilter
// &inBroadPhaseLayerFilter, const ObjectLayerFilter &inObjectLayerFilter);
...
// TwoBodyConstraint * JPC_BodyInterface_CreateConstraint(JPC_BodyInterface *self, const TwoBodyConstraintSettings *inSettings, JPC_BodyID
// inBodyID1, JPC_BodyID inBodyID2); JPC_API void JPC_BodyInterface_ActivateConstraint(JPC_BodyInterface *self, const TwoBodyConstraint
// *inConstraint); RefConst<Shape> JPC_BodyInterface_GetShape(const JPC_BodyInterface *self, JPC_BodyID inBodyID);

JPC_API void JPC_BodyInterface_SetShape(const JPC_BodyInterface* self,
                                        JPC_BodyID inBodyID,
...
JPC_API void JPC_BodyInterface_NotifyShapeChanged(const JPC_BodyInterface* self,
                                                  JPC_BodyID inBodyID,
                                                  JPC_Vec3 inPreviousCenterOfMass,
                                                  bool inUpdateMassProperties,
                                                  JPC_Activation inActivationMode) {
...
JPC_API void JPC_BodyInterface_SetPositionAndRotation(JPC_BodyInterface* self,
                                                      JPC_BodyID inBodyID,
...
JPC_API void JPC_BodyInterface_SetPositionAndRotationWhenChanged(JPC_BodyInterface* self,
                                                                 JPC_BodyID inBodyID,
                                                                 JPC_RVec3 inPosition,
                                                                 JPC_Quat inRotation,
                                                                 JPC_Activation inActivationMode) {
...
JPC_API void JPC_BodyInterface_GetPositionAndRotation(const JPC_BodyInterface* self,
                                                      JPC_BodyID inBodyID,
                                                      JPC_RVec3* outPosition,
                                                      JPC_Quat* outRotation) {
    JPH::RVec3 outPos{};
    JPH::Quat outRot{};
...
JPC_API void JPC_BodyInterface_SetPosition(JPC_BodyInterface* self,
                                           JPC_BodyID inBodyID,
                                           JPC_RVec3 inPosition,
                                           JPC_Activation inActivationMode) {
...
JPC_API void JPC_BodyInterface_SetRotation(JPC_BodyInterface* self,
                                           JPC_BodyID inBodyID,
                                           JPC_Quat inRotation,
                                           JPC_Activation inActivationMode) {
...
JPC_API void JPC_BodyInterface_MoveKinematic(JPC_BodyInterface* self,
                                             JPC_BodyID inBodyID,
                                             JPC_RVec3 inTargetPosition,
                                             JPC_Quat inTargetRotation,
                                             float inDeltaTime) {
    to_jph(self)->MoveKinematic(to_jph(inBodyID), to_jph(inTargetPosition), to_jph(inTargetRotation), inDeltaTime);
}

JPC_API void JPC_BodyInterface_SetLinearAndAngularVelocity(JPC_BodyInterface* self,
                                                           JPC_BodyID inBodyID,
                                                           JPC_Vec3 inLinearVelocity,
                                                           JPC_Vec3 inAngularVelocity) {
    to_jph(self)->SetLinearAndAngularVelocity(to_jph(inBodyID), to_jph(inLinearVelocity), to_jph(inAngularVelocity));
}

JPC_API void JPC_BodyInterface_GetLinearAndAngularVelocity(const JPC_BodyInterface* self,
                                                           JPC_BodyID inBodyID,
                                                           JPC_Vec3* outLinearVelocity,
                                                           JPC_Vec3* outAngularVelocity) {
    JPH::Vec3 outLinVel;
    JPH::Vec3 outAngVel;
...
JPC_API void JPC_BodyInterface_AddLinearAndAngularVelocity(JPC_BodyInterface* self,
                                                           JPC_BodyID inBodyID,
                                                           JPC_Vec3 inLinearVelocity,
                                                           JPC_Vec3 inAngularVelocity) {
...
JPC_API void JPC_BodyInterface_SetPositionRotationAndVelocity(JPC_BodyInterface* self,
                                                              JPC_BodyID inBodyID,
                                                              JPC_RVec3 inPosition,
                                                              JPC_Quat inRotation,
                                                              JPC_Vec3 inLinearVelocity,
                                                              JPC_Vec3 inAngularVelocity) {
    to_jph(self)->SetPositionRotationAndVelocity(to_jph(inBodyID), to_jph(inPosition), to_jph(inRotation), to_jph(inLinearVelocity),
                                                 to_jph(inAngularVelocity));
}
...
JPC_API void JPC_BodyInterface_SetMotionType(JPC_BodyInterface* self,
                                             JPC_BodyID inBodyID,
                                             JPC_MotionType inMotionType,
                                             JPC_Activation inActivationMode) {
...
JPC_API bool JPC_NarrowPhaseQuery_CastRay(const JPC_NarrowPhaseQuery* self, JPC_NarrowPhaseQuery_CastRayArgs* args) {
    ...
    bool hit = to_jph(self)->CastRay(to_jph(args->Ray), result, *bplFilter, *olFilter, *bodyFilter);
...
JPC_API void JPC_PhysicsSystem_Init(JPC_PhysicsSystem* self,
    ...
    to_jph(self)->Init(inMaxBodies, inNumBodyMutexes, inMaxBodyPairs, inMaxContactConstraints, *impl_inBroadPhaseLayerInterface,
                       *impl_inObjectVsBroadPhaseLayerFilter, *impl_inObjectLayerPairFilter);
}
...
JPC_API JPC_PhysicsUpdateError JPC_PhysicsSystem_Update(JPC_PhysicsSystem* self,
                                                        float inDeltaTime,
                                                        int inCollisionSteps,
                                                        JPC_TempAllocatorImpl* inTempAllocator,
                                                        JPC_JobSystemThreadPool* inJobSystem) {
    auto res = to_jph(self)->Update(inDeltaTime, inCollisionSteps, to_jph(inTempAllocator), to_jph(inJobSystem));

    return to_integral(res);
}

static JPC_ContactListener* contactListener;
...
class MyContactListener : public JPH::ContactListener {
   public:
    virtual void OnContactAdded(const JPH::Body& inBody1,
        ...
        auto contact1   = inManifold.GetWorldSpaceContactPointOn1(0);
        auto contact2   = inManifold.GetWorldSpaceContactPointOn2(0);
        JPC_Body* body1 = (JPC_Body*)&inBody1;
        JPC_Body* body2 = (JPC_Body*)&inBody2;

        JPC_ContactProperties properties = {};
        properties.subShapeId1           = inManifold.mSubShapeID1.GetValue();
        properties.subShapeId2           = inManifold.mSubShapeID2.GetValue();
        properties.penetrationDepth      = inManifold.mPenetrationDepth;

        properties.worldSpaceNormal[0] = inManifold.mWorldSpaceNormal.mValue[0];
        properties.worldSpaceNormal[1] = inManifold.mWorldSpaceNormal.mValue[1];
        properties.worldSpaceNormal[2] = inManifold.mWorldSpaceNormal.mValue[2];

        properties.contactPointOn1[0] = contact1[0];
        properties.contactPointOn1[1] = contact1[1];
        properties.contactPointOn1[2] = contact1[2];

        properties.contactPointOn2[0] = contact2[0];
        properties.contactPointOn2[1] = contact2[1];
        properties.contactPointOn2[2] = contact2[2];

        properties.isSensor = ioSettings.mIsSensor;

        contactListener->OnContactAdded(body1, body2, properties);
    }
    ...
    virtual void OnContactPersisted(const JPH::Body& inBody1,
        ...
        JPC_ContactProperties properties = {};
        properties.subShapeId1           = to_jpc(inManifold.mSubShapeID1);
        properties.subShapeId2           = to_jpc(inManifold.mSubShapeID2);
        properties.penetrationDepth      = inManifold.mPenetrationDepth;
        ...
        contactListener->OnContactPersisted(body1, body2, properties);
    }

    virtual void OnContactRemoved(const JPH::SubShapeIDPair& inSubShapePair) override {

        JPC_BodyID bodyId1 = to_jpc(inSubShapePair.GetBody1ID());
        JPC_BodyID bodyId2 = to_jpc(inSubShapePair.GetBody2ID());

        JPC_SubShapeID subShapeId1 = to_jpc(inSubShapePair.GetSubShapeID1());
        JPC_SubShapeID subShapeId2 = to_jpc(inSubShapePair.GetSubShapeID2());

        contactListener->OnContactRemoved(bodyId1, bodyId2, subShapeId1, subShapeId2);
    }
};

MyContactListener contact_listener;

JPC_API void JPC_PhysicsSystem_SetContactListener(JPC_PhysicsSystem* self, JPC_ContactListener* contactListenerIncoming) {
    if (contactListener) return;  // alrady registered
    JPH::PhysicsSystem* system = (JPH::PhysicsSystem*)self;
    contactListener            = contactListenerIncoming;
